...
<div class="two-content-div glass">
  ...
  <div>
    <span class="title">Slot Leader in a Branch</span><br>
    <span> slot leader in a garage manages scheduling, staff training,
      and quality control to ensure efficient service and high standards.
      They oversee customer appointments, staff allocation, and work
      progress to deliver prompt and
      service while maintaining the garage's reputation and driving growth.</span>
  </div>
</div>
