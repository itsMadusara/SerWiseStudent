    ...
    <div class="change-password-popup" id="passwordDiv">
        <div class="change-password-popup-content">
            ...
            <form method="post" action="/SerWise_war/changePassword">
                <input type="password" name="newPassword" pattern="{8,}" id="newPassword" placeholder="New Password" autocomplete="off" required> <br>
                <input type="password" name="newPassword1" pattern="{8,}" id="newPassword1" placeholder="Re-enter New Password" required><br>
                <input type="text" name="otpInput" pattern="[0-9]{4}" id="opt" placeholder="OTP" autocomplete="off" required><br>
    ...
    if(session.getAttribute("employeeId")==null){
        ...
        switch (auth){
            ...
            case 4:
                ...
                break;
            case 5:
                out.print("<script src=\"/SerWise_war/StoreKeeper/StoreKeeperHeader.js\"></script>");
                break;
            case 6:
                out.print("<script src=\"/SerWise_war/Cashier/CashierHeader.js\"></script>");
                break;
            case 7:
                out.print("<script src=\"/SerWise_war/Security/SecurityHeader.js\"></script>");
                break;
            case 8:
                out.print("<script src=\"/SerWise_war/SlotLeader/SlotLeaderHeader.js\"></script>");
                break;
        }
    }
%>
