    ...
    <div class="two-content-div">
        ...
        <div class="two-content-div-form">
            <form method="post" action="/SerWise_war/addbranch">
                ...
                <input type="text" name="location" placeholder="Branch Location (City)"><br>
                <input type="text" name="address" placeholder="Address"><br>
                <input type="text" name="noOfSlots" placeholder="No of Slots"><br>
                <input type="text" name="branchManagerID" placeholder="Branch Manager ID"><br>
